...
**남은 슬라이스는 5건이다**(2026-08-25): `S3.3` · `S4.3` · `S5.3b` · `S5.4` · `S7.2`.

그중 **즉시 착수 가능 4건** — `S3.3` · `S4.3` · `S5.3b` · `S7.2`. **남은 사슬은 `S5.3b`→`S5.4` 하나뿐이고 그것이 유일한 미착수 선행이다** — 그래프 레인은 `S6.2` 로, verify 레인은 `S5.2b` 로 이미 풀렸다.
