...
/** P2r-4: risk.approved 소비자 스트림 prefix·그룹(BaseConsumer start('main')→RISK_STREAM). */
export const RISK_PREFIX = 'manager:risk'
export const RISK_GROUP = 'manager-risk-consumers'
