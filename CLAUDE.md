...
| xzawedManager | 3001 | ✅ 71/71 | Claude tool-calling 루프, 하위 에이전트 디스패치; github-ops ToolHandler | [CLAUDE.md](xzawedManager/CLAUDE.md) |
| xzawedShared | — | ✅ 2/2 | 에이전트 서비스 공통 BaseConsumer + validateWorkspaceRoot 라이브러리 (@xzawed/agent-streams) | [CLAUDE.md](xzawedShared/CLAUDE.md) |
