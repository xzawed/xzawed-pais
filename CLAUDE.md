...
| 서비스 | 포트 | 상태 | 역할 | 상세 |
|---|---|---|---|---|
| xzawedOrchestrator | 3000 | ✅ 65/65 | 사용자 지시 수신·정제 후 Manager에 전달 | [CLAUDE.md](xzawedOrchestrator/CLAUDE.md) |
...
xzawedOrchestrator 추가: **@modelcontextprotocol/sdk** (MCP 서버), **React 19 + Zustand + Electron** (데스크톱 UI), **Turborepo** (xzawedOrchestrator·xzawedManager 모노레포).
